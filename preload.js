...
const fileManagerApi = {
  ...
  // Linux: native webContents.startDrag is the default (works on Wayland and
  // X11); PRISM_NATIVE_DRAG=0 falls back to the HTML5 drag session.
  nativeDragOverride: process.env.PRISM_NATIVE_DRAG !== "0",
